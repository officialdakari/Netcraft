...
namespace Minecraft2D
{
    public partial class HelpWindow
    {
        ...
        {
            HT.Add("Управление", "Чтобы перемещаться используйте клавиши 'A', 'D', 'W'. Кнопка 'A' перемещает игрока влево, 'D' - вправо, 'W' - прыжок. Чтобы открыть чат нажмите 'C', инвентарь - 'E'.");
            ...
            HT.Add("Чат и команды", "В игре также есть чат и команды. Чат больше НЕ открывается в отдельном окне. Если Вы закрыли чат, Вы можете снова его открыть нажав кнопку [Чат] в игре. Команды начинаются с символа \"/\" (В NCore). Чтобы получить список команд используйте \"/help\" (В NCore).");
